...
- **B.Sc. Computer Science** — International University, VNU-HCM

## Academic Interests

- Natural Language Processing (NLP)
- Generative AI
- Mathematics practice: Calculus, Linear Algebra, Probability

See my [mathtoolkit](https://github.com/cresht2606/mathtoolkit) GitHub repository for sample tests and notes.
